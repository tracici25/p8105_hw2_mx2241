...
```
  ...
  - The pols file describes the number of politicians of each party
    through out the history, variables of interest containing: gov\_dem,
    gov\_gop, month, month\_name, president, rep\_dem, rep\_gop,
    sen\_dem, sen\_gop, year. It has 822 rows and 10 columns. The range
    of year is from 1947 to 2015.
  - The snp file describes the Standard & Poor’s stock market index at
    each given time, variables of interests containing close, month,
    month\_name, year. It has 787 rows and 4 columns. The range of year
    is from 1950 to 2015.
  - The unemployment file describes the percentage of unemployment at
    each given time, the variables of interest containing month,
    month\_name, unemployment\_rate, year. It has 816 rows and 4
    columns. The range of year is from 1948 to 2015.
  - After merging and combining three datasets by time period,
    `merged_df` was created, which has variables of interests: close,
    gov\_dem, gov\_gop, month, month\_name, month.x, month.y, president,
    rep\_dem, rep\_gop, sen\_dem, sen\_gop, unemployment\_rate, year. It
    has 822 rows and 14 columns. The range of year is from 1947 to 2015.
